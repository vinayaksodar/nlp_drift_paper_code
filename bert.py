...
def main():
    ...
    bert_model_path ='/Users/vinayak/Development/nlp_drift_paper_code/saved_models/bert'
    ...
    output_path='/Users/vinayak/Development/nlp_drift_paper_code/results/bert-pca.csv'
    if os.path.exists(output_path):
        df_agnews.to_csv(output_path,mode='a',index=False,header=False)
    else:
        df_agnews.to_csv('/Users/vinayak/Development/nlp_drift_paper_code/results/bert-pca.csv',index=False)
